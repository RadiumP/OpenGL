...
int main()
{
	...
	Shaders shader("cubemaps.vs", "cubemaps.fs");
	Shaders envShader("envmap.vs", "envmap.fs");
	Shaders skyboxShader("skybox.vs", "skybox.fs");
	...
	glBufferData(GL_ARRAY_BUFFER, sizeof(envVertices), &envVertices, GL_STATIC_DRAW);
	glEnableVertexAttribArray(0);
