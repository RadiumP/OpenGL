...
int main()
{
	...
	Shaders lightingShader("6.multiple_lights.vs", "6.multiple_lights.fs");
	Shaders lightCubeShader("6.light_cube.vs", "6.light_cube.fs");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		lightingShader.setVec3("pointLights[0].ambient", pointLightColor * 0.1f);
		lightingShader.setVec3("pointLights[0].diffuse", pointLightColor);
		lightingShader.setVec3("pointLights[0].specular", pointLightColor);
		...
		lightingShader.setVec3("pointLights[1].ambient", pointLightColor * 0.1f);
		lightingShader.setVec3("pointLights[1].diffuse", pointLightColor);
		lightingShader.setVec3("pointLights[1].specular", pointLightColor);
		...
		lightingShader.setVec3("pointLights[2].ambient", pointLightColor * 0.1f);
		lightingShader.setVec3("pointLights[2].diffuse", pointLightColor);
		lightingShader.setVec3("pointLights[2].specular", pointLightColor);
		...
		lightingShader.setVec3("pointLights[3].ambient", pointLightColor * 0.1f);
		lightingShader.setVec3("pointLights[3].diffuse", pointLightColor);
		lightingShader.setVec3("pointLights[3].specular", pointLightColor);
		...
		lightCubeShader.use();
		lightCubeShader.setMat4("projecetion", projection);
