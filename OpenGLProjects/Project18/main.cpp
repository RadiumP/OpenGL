...
int main()
{
	...
	Shaders shader("bloom.vs", "bloom.fs");
	Shaders shaderLight("bloom.vs", "light_box.fs");
	Shaders shaderBlur("blur.vs", "blur.fs");
	Shaders shaderBloomFinal("bloom_final.vs", "bloom_final.fs");
