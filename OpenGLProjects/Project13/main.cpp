...
void renderScene(const Shaders& shader);
void renderCube();
void renderQuad();
...
int main()
{
	...
	Shaders shader("shadow_mapping.vs", "shadow_mapping.fs");
	Shaders simpleDepthShader("depth.vs", "depth.fs");
	Shaders debugDepthQuad("debug.vs", "debug.fs");
