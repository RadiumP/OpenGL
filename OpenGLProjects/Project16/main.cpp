...
int main()
{
	...
	//Shaders shader("parallax.vs", "parallax.fs");
	//Shaders shader("parallax.vs", "parallax1.fs");
	Shaders shader("parallax.vs", "parallax2.fs");
	...
	unsigned int diffuseMap = loadTexture("../../resources/textures/toy_box_diffuse.png", false);
	unsigned int normalMap = loadTexture("../../resources/textures/toy_box_normal.png", false);
	unsigned int heightMap = loadTexture("../../resources/textures/toy_box_disp.png", false);
